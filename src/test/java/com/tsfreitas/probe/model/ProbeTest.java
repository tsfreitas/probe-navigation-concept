...
public class ProbeTest {
	...
	public void deveVirarParaADireita() {
		// GIVEN
		probe = new Probe(1, 1, DIRECTION.NORTH);
	...
	public void deveAndarParaOSul() {
		// GIVEN
		probe = new Probe(1, 1, DIRECTION.SOUTH);
	...
	public void deveAndarParaOLeste() {
		// GIVEN
		probe = new Probe(1, 1, DIRECTION.EAST);
	...
	public void deveAndarParaOOeste() {
		// GIVEN
		probe = new Probe(1, 1, DIRECTION.WEST);
	...
	private void validateProbe(int x, int y, DIRECTION direction) {
		Assert.assertEquals(x, probe.getX());
		Assert.assertEquals(y, probe.getY());
